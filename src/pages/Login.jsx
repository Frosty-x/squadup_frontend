...
const Login = () => {
  ...
  const socialIcons = ["in", "f", "@", "t", "G+"];
  const inputClasses = "w-full px-4 py-3 rounded-lg text-gray-100 placeholder-gray-200 border-b border-white bg-white/5 focus:outline-none focus:border-red-600 focus:bg-white/10 hover:bg-white/10 transition-all duration-300";
  ...
  return (
    <div className="h-screen w-screen flex overflow-hidden mainscreen text-gray-200">
      ...
      <div className="flex items-center justify-center p-16 w-1/2">
        <div className="w-[900px] h-[500px] rounded-3xl p-10 backdrop-blur-sm bg-black/10 border border-white/30 shadow-2xl opacity-0 animate-scale-in [animation-delay:0.3s] [animation-fill-mode:forwards]">
