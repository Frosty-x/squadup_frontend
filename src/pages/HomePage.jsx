...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-x-hidden overflow-y-auto w-full max-w-full">
      ...
      <section className="relative flex items-center justify-center pt-24 pb-16 px-6 bg-ldinear-to-br from-black via-neutral-900 to-red-950/20 overflow-hidden">
        ...
        <div className="max-w-7xl w-full grid grid-cols-1 md:grid-cols-2 gap-12 items-center relative z-10">
          ...
          <div className="space-y-6 animate-slideInLeft max-w-xl">
            ...
            <h1 className="text-5xl lg:text-7xl font-black leading-tight tracking-tight">
              <span className="block text-white mb-2 bg-linear-to-r from-white to-gray-300 bg-clip-text">FIND YOUR</span>
              <span className="block bg-linear-to-r from-red-600 via-red-500 to-orange-500 bg-clip-text text-transparent">PERFECT TEAMMATE!</span>
            </h1>
          ...
          <div className="hidden md:flex justify-center animate-slide-up items-center relative translate-y-[50px]">
            <div className="relative w-120 h-160 rounded-2xl border-2 border-red-600/30 flex items-center justify-center bg-gradient-to-br from-red-950/20 to-transparent backdrop-blur-sm shadow-2xl shadow-red-900/30">
              <div className="absolute inset-0 rounded-2xl bg-linear-to-t from-red-600/20 to-transparent"></div>
              <img
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              {
                icon: <Star className="text-red-500" size={40} />,
                title: "Rate Players",
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-gray-400 badscript leading-relaxed">{item.text}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-24 px-6 text-center relative bg-linear-to-b from-black to-neutral-900">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
            {["Create Profile", "Find Matches", "Play & Rate"].map(
              (title, i) => (
                <div key={i} className="relative">
                  <div className="relative inline-block mb-6">
                    ...
                    <div className="absolute -top-2 -right-2 w-8 h-8 bg-linear-to-br from-red-500 to-orange-500 rounded-full animate-pulse"></div>
                    <div className="absolute -bottom-2 -left-2 w-6 h-6 bg-red-600 rounded-full animate-pulse delay-500"></div>
                  </div>
                  <h3 className="text-2xl font-bold text-white mb-4 hover:text-red-500 transition-colors">{title}</h3>
